...
\begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=0.75\paperwidth]{figures/chapter_4/wytham.png}}
\end{center}
    \vspace*{\fill}
\begin{center}
...
% \clearpage{\pagestyle{empty}\cleardoublepage} % empty page before chapter
\fancyhead[RO]{\sffamily\color{black50}Merino Recalde \textit{et al}., 2023\hspace{2em}\thepage}
\fancyhead[LE]{\sffamily\color{black50}\thepage\hspace{2em}Melodic and rhythmic biases in great tit songs}
\onecolumn % start one-column layout for chatper 4
